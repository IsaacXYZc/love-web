...
const Card3dModel = ({path, imgUrl}) => {
  ...
  useEffect(() => {
    ...
    //       model2.position.set(-4, 6, -3);
    //     } else {
    //       model2.scale.set(1, 1, 1);
    //       model2.position.set(0, 6, -3);
    //     }
    //     scene.add(model2);
  ...
  return<div className="relative w-full h-screen flex justify-center items-center">
  <img
    src={imgUrl}
    alt="descarga"
