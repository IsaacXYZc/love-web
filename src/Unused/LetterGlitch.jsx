...
const LetterGlitch = ({
  glitchColors = ['#b15482', '#dc6161', '#c861dc'],
  glitchSpeed = 30,
  ...
  const lettersAndSymbols = [
    'LOVE', 'AMOR','NATH','NATY' /*'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M',
  ...
  const drawLetters = () => {
    ...
    letters.current.forEach((letter, index) => {
        // console.log(letter)
      const x = (index % grid.current.columns) * charWidth * letter.char.length;
  ...
  const outerVignetteStyle = {
    ...
    height: '100%',
    pointerEvents: 'none',
    background: 'radial-gradient(circle, rgba(0,0,0,0) 60%, rgba(255, 152, 152, 1) 100%)',
  };
